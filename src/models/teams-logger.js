...
function log (level = 'info') {
  return async function () {
    ...
    const textPrefix = `${packageName} ${packageVersion} on ${hostname} in ${location} - ${level}: `
    const markdownPrefix = `**${packageName} ${packageVersion}** on **${hostname}** in **${location}** - **${level}**: `
